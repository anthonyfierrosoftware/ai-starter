...
const ChatPanel = ({ chatToLoad, chatMode }) => {
  ...
  const sendMultiplePrompt = () => {
    ...
    sendPrompt(
      ...
      chatMode == "On" ? claudeChatId : false
    );
    sendPrompt(
      "Llama",
      messageValue,
    ...
    sendPrompt(
      ...
      chatMode == "On" ? mistralChatId : false
    );
  };
