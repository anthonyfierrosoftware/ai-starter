    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_%(app_label)s.%(class)s_set+', to='contenttypes.contenttype')),
                ('llmConfig', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='conversation', to='aiModule.llmconfiguration')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateCreated', models.DateTimeField(default=django.utils.timezone.now)),
                ('totalTokens', models.IntegerField(blank=True, default=0, null=True)),
                ('llm', models.CharField(blank=True, max_length=24, null=True)),
                ('chat_model', models.TextField(blank=True, null=True)),
