...
class Conversation(PolymorphicModel):
    ...
    owner = models.ForeignKey("users.Profile", default=None, blank=True, null=True, on_delete=models.CASCADE, related_name="conversations")
    ...
    llmConfig = models.ForeignKey("aiModule.LLMConfiguration", default=None, blank=True, null=True, on_delete=models.SET_NULL, related_name="conversation")
