...
class ClaudeWrapper(AbstractWrapper):
    ...
    def set_conversation_history(self, ch: list= None):
        try:
            ...
            print(f"Error checking system config in claude wrapper set_conversation_history: {e}")
    ...
    def send_text_chat(self, message='', system_instructions=None, model_id = None, reset=False,  temp=1, top_p = 1):
        '''
