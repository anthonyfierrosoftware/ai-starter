...
def error_list_object(field, message):
    return {"errorTitle": field, "errorMessage": message}


def success_200_json(data, custom_message):
    response = {"status": 200, "data": data, "message": custom_message}
    return (response, status.HTTP_200_OK)


def success_201_json(data, custom_message):
    response = {"status": 201, "data": data, "message": custom_message}
    return (response, status.HTTP_201_CREATED)


def success_202_json(data, custom_message):
    response = {"status": 202, "data": data, "message": custom_message}
...
def success_204_json(data=None, custom_message=None):
    response = {
        ...
        "message": (
            custom_message
            if custom_message
            else "Request successful, no content to return."
        ),
    }
        ...
        "data": {
            "error": {
                ...
                "errorMessage": (
                    data
                    if data
                    else "Client request is invalid and cannot be processed."
                ),
            }
        },
    }
        ...
        "data": {
            "error": {
                ...
                "errorMessage": (
                    data
                    if data
                    else "The request lacks valid authentication credentials for the requested resource."
                ),
            }
        },
    }
    ...
    response = {
        ...
        "data": {
            "error": {
                ...
                "errorMessage": (
                    data if data else "You do not have access to this resource."
                ),
            }
        },
    }
        ...
        "data": {
            "error": {
                ...
                "errorMessage": (
                    data
                    if data
                    else "The requested resource does not exist. Please ensure you entered the correct URL."
                ),
            }
        },
    }
...
def error_406_json(data, custom_message=None):
    ...
    """
    response = {"status": 406, "data": {"errors": data}, "message": custom_message}
...
def error_412_json(data, custom_message=None):
    ...
    Pass an array of errorList objects as defined in the fuinction above
    """
    response = {"status": 412, "data": {"errors": data}, "message": custom_message}
...
def error_422_json(data, custom_message=None):
    ...
    Pass an array of errorList objects as defined in the fuinction above
    """
    response = {"status": 422, "data": {"errors": data}, "message": custom_message}
...
def error_460_json(data, custom_message=None):
    ...
    response = {
        "status": 460,
        "data": {"errors": f"Expired Subscription {data}."},
        "message": custom_message,
    }
    return (response, 460)
        ...
        "data": {
            "error": {
                ...
                "errorMessage": (
                    data
                    if data
                    else "Oops! Something went wrong. Please contact support"
                ),
            }
        },
    }
...
def generate_response(status, data, custom_message=None, field=False):
    ...
    try:
        ...
        raise ValueError(
            "If you are throwing an error, make sure you provide and error_field parameter, if you are returning a success please provide the data."
        )
