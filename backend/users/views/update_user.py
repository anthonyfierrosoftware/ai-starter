...
from users.serializers.user_serializers import UserUpdateSerializer, UserResponseSerializer
    ...
    def put(self, request):
        ...
        try:
            ...
            try:
                ...
                return generate_response(status=422, data=error_list_object("Metadata", "Could not process meta data please ensure it is correctly formatted."), custom_message=str(e)+".")
            
            serializer = UserUpdateSerializer(user, data=data, partial=True)
            profile_serializer = ProfileUpdateSerializer(user.profile, data=data, partial=True)
            ...
            for err in profile_serializer.errors:
                ...
                try:
                    ret.append(error_list_object(err, str(profile_serializer.errors[err][0])))
                except Exception as e:
                    print(f"error processing serializer errors: {e}")
