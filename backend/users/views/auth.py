    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            try:
                ...
                ret = error_list_object("Password","Could not retrieve required data from body.")
                return generate_response(status=422,  data=ret, custom_message="Invalid Request")
                    
            if not password1 == password2:
                ret = error_list_object("Password1","Passwords do not match")
                return generate_response(status=422,  data=ret, custom_message="Invalid password")
            try:
            ...
            return generate_response(status=200, data=None, custom_message="password changed")
...
class LogOut(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return generate_response(status=200, data=None, custom_message="User is logged out")
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            try:
                ...
                error= [error_list_object("Email", "The email and password you provided are incorrect.")]
            ...
            if serializer.is_valid():
                ...
                error= [error_list_object("Email","The username and password you provided are incorrect.")]
                return generate_response(status=401, data=error, custom_message=None )
