    ...
    def post(self, request):
        ...
        try:
            ...
            try:
                ...
                error = [
                    error_list_object(
                        "Email", "No user assosciated with the email provided."
                    )
                ]
            ...
            try:
                ...
                return generate_response(
                    status=500,
                    data=str(e) + ".",
                    custom_message="Could not send email.",
                )
            ...
            return generate_response(
                status=200,
                data=None,
                custom_message="temporary password has been emailed.",
            )
            ...
            return generate_response(
                status=500,
                data=str(e) + ".",
                custom_message="Server error processing forgot password.",
            )
